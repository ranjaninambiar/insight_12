...
def CostofOrder():
    ...
    Cost1= str(Qty1 * UnitPrice1)
    Cost2= str(Qty2 * UnitPrice2)
    Cost3= str(Qty3 * UnitPrice3)
    Cost4= str(Qty4 * UnitPrice4)
    Cost5= str(Qty5 * UnitPrice5)
...
UnitPricePendrive.set(0)
UnitPriceMobile.set(0)
UnitPriceCalculator.set(0)
UnitPricePowerBank.set(0)
UnitPriceBluetoothHeadset.set(0)
...
txtCustomerName = Entry(LeftInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=CustomerName)
...
txtCustomerPhone = Entry(LeftInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=CustomerPhone)
...
txtCustomerEmail = Entry(LeftInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=CustomerEmail)
...
txtDateofOrder = Entry(RightInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=DateofOrder)
...
txtTimeofOrder = Entry(RightInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=TimeofOrder)
...
txtCustomerRef = Entry(RightInsideLF ,font=('Magneto', 12, 'bold'), bd=20, width=43, bg="blue", justify='left', textvariable=CustomerRef)
...
#-----------------------------------------------------
lblMethodofPayment=Label(RightInsideLFLF ,font=('Magneto', 12, 'bold'),text="Method of Payment", fg="black", bd=16, anchor='w')
...
txtDiscount=Entry(RightInsideLFLF ,font=('Magneto', 12, 'bold'), bd=16, width=12, bg="blue", justify='left', textvariable=Discount)
...
txtTax=Entry(RightInsideLFLF ,font=('Magneto', 12, 'bold'), bd=16, width=12, bg="blue", justify='left', textvariable=Tax)
...
txtSubTotal = Entry(RightInsideLFLF ,font=('Magneto', 12, 'bold'), bd=16, width=12, bg="blue", justify='left', textvariable=SubTotal)
...
txtTotalCost = Entry(RightInsideLFLF ,font=('Magneto', 12, 'bold'), bd=16, width=12, bg="blue", justify='left', textvariable=TotalCost)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
txtQtyPendrive=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=QtyPendrive)
txtQtyPendrive.grid(row =1, column=1)
txtQtyMobile=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=QtyMobile)
txtQtyMobile.grid(row =2, column=1)
txtQtyCalculator=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=QtyCalculator)
txtQtyCalculator.grid(row =3, column=1)
txtQtyPowerBank=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=QtyPowerBank)
txtQtyPowerBank.grid(row =4, column=1)
txtQtyBluetoothHeadset=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=QtyBluetoothHeadset)
txtQtyBluetoothHeadset.grid(row =5, column=1)
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
txtUnitPricePendrive=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=UnitPricePendrive)
txtUnitPricePendrive.grid(row =1, column=2)
txtUnitPriceMobile=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=UnitPriceMobile)
txtUnitPriceMobile.grid(row =2, column=2)
txtUnitPriceCalculator=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=UnitPriceCalculator)
txtUnitPriceCalculator.grid(row =3, column=2)
txtUnitPricePowerBank=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=UnitPricePowerBank)
txtUnitPricePowerBank.grid(row =4, column=2)
txtUnitPriceBluetoothHeadset=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=UnitPriceBluetoothHeadset)
txtUnitPriceBluetoothHeadset.grid(row =5, column=2)
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
txtCostofPendrive=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=CostofPendrive)
txtCostofPendrive.grid(row =1, column=3)
txtCostofMobile=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=CostofMobile)
txtCostofMobile.grid(row =2, column=3)
txtCostofCalculator=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=CostofCalculator)
txtCostofCalculator.grid(row =3, column=3)
txtCostofPowerBank=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=CostofPowerBank)
txtCostofPowerBank.grid(row =4, column=3)
txtCostofBluetoothHeadset=Entry(LeftInsideLFLF ,font=('Magneto', 12, 'bold'), bd=10, width=10, bg="blue", justify='left', textvariable=CostofBluetoothHeadset)
...
#------------------------------------------------------------------------------------------------------------------------
btnTotalCost=Button(RightInsideRFRF, pady=8, bd=8, fg="black", font=('Magneto', 16, 'bold'), width=11, text="TotalCost", bg="white", command=CostofOrder).grid(row=0 , column=0)
btnReset=Button(RightInsideRFRF, pady=8, bd=8, fg="black", font=('Magneto', 16, 'bold'), width=11, text="Reset", bg="white",command=Reset).grid(row=1 , column=0)
btnOrderRef=Button(RightInsideRFRF, pady=8, bd=8, fg="black", font=('Magneto', 16, 'bold'), width=11, text="Order Ref", bg="white", command=OrderRef).grid(row=2 , column=0)
btnExit=Button(RightInsideRFRF, pady=8, bd=8, fg="black", font=('Magneto', 16, 'bold'), width=11, text="Exit", bg="white", command=Exit).grid(row=3 , column=0)
